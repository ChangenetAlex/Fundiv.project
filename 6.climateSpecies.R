...
#Fonction
ExtractClimate = function(Dir=c("/home/achangenet/Documents/FUNDIV - NFI - Europe/"),
  ...
  { dir.create(path=paste0(Dir,"our-data/species/",CODE,"/"))
    save(Sp, file=paste0(Dir,"our-data/species/",CODE,"/",CODE,"_all.RData"))
    save(summary_all, file=paste0(Dir,"our-data/species/",CODE,"/",CODE,"_summary.RData"))
    save(Sp2, file=paste0(Dir,"our-data/species/",CODE,"/",CODE,"_allVariable.RData"))} #Here the database is saved in the same file
  }
