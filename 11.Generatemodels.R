...
for (i in 1:nrow(n)){
  for (j in 1:nrow(n2)){
    ...
    vardep1 <- paste0("Mbin",i,Nom[j]," <- fitme(",vardep[2]," ~ ",collapse = "")
    vardep11 <- paste0("M2bin",i,Nom[j]," <- fitme(",vardep[2]," ~ ",collapse = "")
    vardep2 <- paste0("MnbZT",i,Nom[j]," <- fitme(",vardep[1]," ~ ",collapse = "")
