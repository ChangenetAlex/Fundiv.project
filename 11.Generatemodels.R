...
for (i in 1:nrow(n)){
  for (j in 1:nrow(n2)){
    ...
    vardep1 <- paste0("try(Mbin",i,Nom[j]," <- fitme(",vardep[2]," ~ ",collapse = "")
    vardep11 <- paste0("try(M2bin",i,Nom[j]," <- fitme(",vardep[2]," ~ ",collapse = "")
    vardep2 <- paste0("try(MnbZT",i,Nom[j]," <- fitme(",vardep[1]," ~ ",collapse = "")
    vardep22 <- paste0("try(M2nbZT",i,Nom[j]," <- fitme(",vardep[1]," ~ ",collapse = "")
    ...
    capture.output(cat(paste0("#M2bin",i,Nom[j]," = ",varAll[1]," ~ ",varAll[2])," + ",n2[j,1]," + ",n2[j,2],"\n",paste0(vardep11,"sqrtBAIj.plot.1 + sqrtBAIj.plot.1.mean + sqrtdbh.plot.mean + treeNbr + yearsbetweensurveys + ",varAll1," + ",varcat,carre,interac1," + ",interac2,random1,finfun,",silent=T)",collapse = ""),"\n",sep=""),file="/home/achangenet/Documents/FUNDIV - NFI - Europe/Myscripts/Fundiv.project/temporaire.R",append = T,type="output",split=F)
    capture.output(cat(paste0("try(Saving(M2bin",i,Nom[j],"),silent=T)"),"\n","\n"),file="/home/achangenet/Documents/FUNDIV - NFI - Europe/Myscripts/Fundiv.project/temporaire.R",append = T,type="output",split=F)
    capture.output(cat(paste0("#MnbZT",i,Nom[j],"nb = ",varAll[1]," ~ ",varAll[2])," + ",n2[j,1]," + ",n2[j,2],"\n",paste0(vardep2,"sqrtBAIj.plot.1 + sqrtBAIj.plot.1.mean + logdbh.plot.mean + treeNbr + yearsbetweensurveys + ",varAll1," + ",varcat,carre,interac1," + ",interac2,random1,finfun1,",silent=T)",collapse = ""),"\n",sep=""),file="/home/achangenet/Documents/FUNDIV - NFI - Europe/Myscripts/Fundiv.project/temporaire.R",append = T,type="output",split=F)
    capture.output(cat(paste0("try(Saving(MnbZT",i,Nom[j],"),silent=T)"),"\n","\n"),file="/home/achangenet/Documents/FUNDIV - NFI - Europe/Myscripts/Fundiv.project/temporaire.R",append = T,type="output",split=F)
    capture.output(cat(paste0("#M2nbZT",i,Nom[j],"nb = ",varAll[1]," ~ ",varAll[2])," + ",n2[j,1]," + ",n2[j,2],"\n",paste0(vardep22,"sqrtBAIj.plot.1 + sqrtBAIj.plot.1.mean + sqrtdbh.plot.mean + treeNbr + yearsbetweensurveys + ",varAll1," + ",varcat,carre,interac1," + ",interac2,random1,finfun1,",silent=T)",collapse = ""),"\n",sep=""),file="/home/achangenet/Documents/FUNDIV - NFI - Europe/Myscripts/Fundiv.project/temporaire.R",append = T,type="output",split=F)
